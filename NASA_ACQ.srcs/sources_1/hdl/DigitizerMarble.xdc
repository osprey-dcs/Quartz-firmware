# Osprey Quad AD7768 Digitizer on Marble
#
# FMC1 
#
# FMC1 LA00 -- FMC1 G6/G7
set_property -dict {PACKAGE_PIN H17 IOSTANDARD LVCMOS25} [get_ports {AD7768_CS_n[0]}]
set_property -dict {PACKAGE_PIN H18 IOSTANDARD LVCMOS25} [get_ports {AD7768_SDO[0]}]

# FMC1 LA01 -- FMC1 D8/D9
set_property -dict {PACKAGE_PIN G17 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[8]}]
...
set_property -dict {PACKAGE_PIN E20 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[11]}]

# FMC1 LA06 -- FMC1 C10/C11
set_property -dict {PACKAGE_PIN L19 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[0]}]
...
set_property -dict {PACKAGE_PIN J19 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[13]}]

# FMC1 LA10 -- FMC1 C14/C15
set_property -dict {PACKAGE_PIN H16 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[2]}]
...
set_property -dict {PACKAGE_PIN D16 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[15]}]

# FMC1 LA14 -- FMC1 C18/C19
set_property -dict {PACKAGE_PIN E15 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[4]}]
set_property -dict {PACKAGE_PIN E16 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[5]}]

# FMC1 LA15 -- FMC1 H19/H20
set_property -dict {PACKAGE_PIN J15 IOSTANDARD LVCMOS25} [get_ports {AD7768_SDI}]
...
set_property -dict {PACKAGE_PIN D10 IOSTANDARD LVCMOS25} [get_ports {AD7768_DRDY[0]}]

# FMC1 LA18 -- FMC1 C22/C23
set_property -dict {PACKAGE_PIN C12 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[6]}]
set_property -dict {PACKAGE_PIN C11 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[7]}]

# FMC1 LA19 -- FMC1 H22/H23
set_property -dict {PACKAGE_PIN H14 IOSTANDARD LVCMOS25} [get_ports {AD7768_SCLK}]
set_property -dict {PACKAGE_PIN G14 IOSTANDARD LVCMOS25} [get_ports {AD7768_START_n}]

# FMC1 LA20 -- FMC1 G21/G22
set_property -dict {PACKAGE_PIN B15 IOSTANDARD LVCMOS25} [get_ports {AD7768_CS_n[1]}]
set_property -dict {PACKAGE_PIN A15 IOSTANDARD LVCMOS25} [get_ports {AD7768_SDO[1]}]

# FMC1 LA21 -- FMC1 H25/H26
set_property -dict {PACKAGE_PIN D14 IOSTANDARD LVDS_25} [get_ports {AD7768_MCLK_P}]
...
set_property -dict {PACKAGE_PIN Y22  IOSTANDARD LVCMOS25} [get_ports {AD7768_CS_n[2]}]
set_property -dict {PACKAGE_PIN AA22 IOSTANDARD LVCMOS25} [get_ports {AD7768_SDO[2]}]

# FMC2 LA01 -- FMC2 D8/D9
set_property -dict {PACKAGE_PIN AA23 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[24]}]
...
set_property -dict {PACKAGE_PIN AC26 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[27]}]

# FMC2 LA06 -- FMC2 C10/C11
set_property -dict {PACKAGE_PIN AD23 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[16]}]
...
set_property -dict {PACKAGE_PIN V26 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[29]}]

# FMC2 LA10 -- FMC2 C14/C15
set_property -dict {PACKAGE_PIN AE23 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[18]}]
...
set_property -dict {PACKAGE_PIN V24 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[31]}]

# FMC2 LA14 -- FMC2 C18/C19
set_property -dict {PACKAGE_PIN U24 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[20]}]
set_property -dict {PACKAGE_PIN U25 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[21]}]

# FMC2 LA15 -- FMC2 H19/H20
set_property -dict {PACKAGE_PIN U22 IOSTANDARD LVCMOS25} [get_ports {COIL_CONTROL_RESET_n}]
...
set_property -dict {PACKAGE_PIN F23 IOSTANDARD LVCMOS25} [get_ports {AD7768_DRDY[3]}]

# FMC2 LA18 -- FMC2 C22/C23
set_property -dict {PACKAGE_PIN G24 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[22]}]
set_property -dict {PACKAGE_PIN F24 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[23]}]

# FMC2 LA19 -- FMC2 H22/H23
set_property -dict {PACKAGE_PIN K23 IOSTANDARD LVCMOS25} [get_ports {COIL_CONTROL_SPI_DOUT}]
