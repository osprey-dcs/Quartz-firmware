...
set_property -dict {PACKAGE_PIN H18 IOSTANDARD LVCMOS25 PULLUP TRUE} [get_ports {AD7768_SDO[1]}]
...
set_property -dict {PACKAGE_PIN K20 IOSTANDARD LVCMOS25} [get_ports {AD7768_DRDY[0]}]
set_property -dict {PACKAGE_PIN J20 IOSTANDARD LVCMOS25 PULLUP TRUE} [get_ports {AD7768_SDO[0]}]
...
set_property -dict {PACKAGE_PIN H19 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[8]}]
set_property -dict {PACKAGE_PIN G20 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[9]}]
...
set_property -dict {PACKAGE_PIN D19 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[10]}]
set_property -dict {PACKAGE_PIN D20 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[11]}]
...
set_property -dict {PACKAGE_PIN L17 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[12]}]
set_property -dict {PACKAGE_PIN K18 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[13]}]
...
set_property -dict {PACKAGE_PIN J15 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[14]}]
set_property -dict {PACKAGE_PIN J16 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[15]}]
...
set_property -dict {PACKAGE_PIN E10 IOSTANDARD LVCMOS25} [get_ports {COIL_CONTROL_RESET_n}]
set_property -dict {PACKAGE_PIN D10 IOSTANDARD LVCMOS25} [get_ports {COIL_CONTROL_SPI_CLK}]
...
#set_property -dict {PACKAGE_PIN D13 IOSTANDARD LVCMOS25} [get_ports {FMC1_LA_P[21]}]
...
set_property -dict {PACKAGE_PIN G12 IOSTANDARD LVCMOS25} [get_ports {COIL_CONTROL_SPI_DOUT}]
set_property -dict {PACKAGE_PIN F12 IOSTANDARD LVCMOS25} [get_ports {COIL_CONTROL_SPI_DIN}]

# FMC1 LA24 -- FMC1 H28/H29
set_property -dict {PACKAGE_PIN A9 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[0]}]
set_property -dict {PACKAGE_PIN A8 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[1]}]

# FMC1 LA25 -- FMC1 G27/G28
set_property -dict {PACKAGE_PIN G10 IOSTANDARD LVCMOS25} [get_ports {AD7768_DCLK[1]}]
set_property -dict {PACKAGE_PIN G9  IOSTANDARD LVCMOS25} [get_ports {AD7768_CS_n[1]}]

# FMC1 LA26 -- FMC1 D26/D27
set_property -dict {PACKAGE_PIN E13 IOSTANDARD LVCMOS25} [get_ports {COIL_CONTROL_SPI_CS_n}]
...
set_property -dict {PACKAGE_PIN J13 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[2]}]
set_property -dict {PACKAGE_PIN H13 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[3]}]

# FMC1 LA29 -- FMC1 G30/G31
set_property -dict {PACKAGE_PIN F9 IOSTANDARD LVCMOS25} [get_ports {AD7768_START_n}]
set_property -dict {PACKAGE_PIN F8 IOSTANDARD LVCMOS25} [get_ports {AD7768_RESET_n}]

# FMC1 LA30 -- FMC1 H34/H35
set_property -dict {PACKAGE_PIN B12 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[4]}]
set_property -dict {PACKAGE_PIN B11 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[5]}]

# FMC1 LA31 -- FMC1 G33/G34
set_property -dict {PACKAGE_PIN A13 IOSTANDARD LVCMOS25} [get_ports {AD7768_DCLK[0]}]
set_property -dict {PACKAGE_PIN A12 IOSTANDARD LVCMOS25} [get_ports {AD7768_SDI}]

# FMC1 LA32 -- FMC1 H37/H38
set_property -dict {PACKAGE_PIN C14 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[6]}]
set_property -dict {PACKAGE_PIN C13 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[7]}]

# FMC1 LA33 -- FMC1 G36/G37
set_property -dict {PACKAGE_PIN B10 IOSTANDARD LVCMOS25} [get_ports {AD7768_SCLK}]
set_property -dict {PACKAGE_PIN A10 IOSTANDARD LVCMOS25} [get_ports {AD7768_CS_n[0]}]
...
#set_property -dict {PACKAGE_PIN AB24 IOSTANDARD LVCMOS25} [get_ports {FMC2_LA_N[1]}]

# FMC2 LA02 -- FMC2 H7/H8
set_property -dict {PACKAGE_PIN AE22 IOSTANDARD LVDS_25} [get_ports {AD7768_MCLK_P}]
set_property -dict {PACKAGE_PIN AF22 IOSTANDARD LVDS_25} [get_ports {AD7768_MCLK_N}]

# FMC2 LA03 -- FMC2 G9/G10
set_property -dict {PACKAGE_PIN AD26 IOSTANDARD LVCMOS25} [get_ports {AMC7823_SPI_CLK}]
set_property -dict {PACKAGE_PIN AE26 IOSTANDARD LVCMOS25} [get_ports {AMC7823_SPI_DIN}]

# FMC2 LA04 -- FMC2 H10/H11
set_property -dict {PACKAGE_PIN V21 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[24]}]
set_property -dict {PACKAGE_PIN W21 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[25]}]
...
set_property -dict {PACKAGE_PIN AB22 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[26]}]
set_property -dict {PACKAGE_PIN AC22 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[27]}]

# FMC2 LA08 -- FMC2 G12/G13
set_property -dict {PACKAGE_PIN AC23 IOSTANDARD LVCMOS25} [get_ports {AMC7823_SPI_DOUT}]
set_property -dict {PACKAGE_PIN AC24 IOSTANDARD LVCMOS25} [get_ports {AMC7823_SPI_CS_n}]
...
set_property -dict {PACKAGE_PIN W23 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[28]}]
set_property -dict {PACKAGE_PIN W24 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[29]}]
...
set_property -dict {PACKAGE_PIN U22 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[30]}]
set_property -dict {PACKAGE_PIN V22 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[31]}]
...
set_property -dict {PACKAGE_PIN K23 IOSTANDARD LVCMOS25} [get_ports {AD7768_DRDY[2]}]
set_property -dict {PACKAGE_PIN J23 IOSTANDARD LVCMOS25 PULLUP TRUE} [get_ports {AD7768_SDO[2]}]

# FMC2 LA20 -- FMC2 G21/G22
set_property -dict {PACKAGE_PIN L22 IOSTANDARD LVCMOS25} [get_ports {AD7768_DRDY[3]}]
set_property -dict {PACKAGE_PIN K22 IOSTANDARD LVCMOS25 PULLUP TRUE} [get_ports {AD7768_SDO[3]}]

# FMC2 LA21 -- FMC2 H25/H26
set_property -dict {PACKAGE_PIN J21 IOSTANDARD LVCMOS25} [get_ports {AD7768_DCLK[2]}]
set_property -dict {PACKAGE_PIN H22 IOSTANDARD LVCMOS25} [get_ports {AD7768_CS_n[2]}]

# FMC2 LA22 -- FMC2 G24/G25
set_property -dict {PACKAGE_PIN E25 IOSTANDARD LVCMOS25} [get_ports {AD7768_DCLK[3]}]
set_property -dict {PACKAGE_PIN D25 IOSTANDARD LVCMOS25} [get_ports {AD7768_CS_n[3]}]
...
set_property -dict {PACKAGE_PIN J24 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[16]}]
set_property -dict {PACKAGE_PIN J25 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[17]}]
...
set_property -dict {PACKAGE_PIN G25 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[18]}]
set_property -dict {PACKAGE_PIN G26 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[19]}]

# FMC2 LA29 -- FMC2 G30/G31
#set_property -dict {PACKAGE_PIN J26 IOSTANDARD LVCMOS25} [get_ports {FMC2_LA_P[29]}]
#set_property -dict {PACKAGE_PIN H26 IOSTANDARD LVCMOS25} [get_ports {FMC2_LA_N[29]}]

# FMC2 LA30 -- FMC2 H34/H35
set_property -dict {PACKAGE_PIN D26 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[20]}]
set_property -dict {PACKAGE_PIN C26 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[21]}]
...
set_property -dict {PACKAGE_PIN B20 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[22]}]
set_property -dict {PACKAGE_PIN A20 IOSTANDARD LVCMOS25} [get_ports {AD7768_DOUT[23]}]
